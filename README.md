...
🔍 Search for any board games

📰 Read news from the board gaming world

📚 Add games to your personal collection

✅ Track and mark played game sessions
...
BGG API (BoardGameGeek)

Architecture: MVVM-C

🌐 API

The app uses the BoardGameGeek (BGG) API to fetch:

board game information

trending and popular games

board game related news
